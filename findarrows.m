function [finallines,longest,newcenter] = findarrows(I,edges,center,maxxy,minxy,debugShow)
    ...
    lines = houghlines(edges, theta, rho, peaks,'FillGap',30,'MinLength',40);
    ...
    %get the final lines and combine close ones based on angle
